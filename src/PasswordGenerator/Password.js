...
function Password() {
  ...
  function Generate(e) {
    ...
    else if(lengthvalue>=10 && array.length === 0 ) {
      setpassword([])
      alert('Please Check atleast one Checkbox')
        ...
        <form action="/" name='passwordvlaue' type='submit' >
          ...
          <div className='content'>
            ...
            <div >
              ...
              <input type="number" min='10' max='20' defaultValue='10' value={lengthvalue} className='passlength-i content-i' onChange={(e) => setlength(e.target.value)} /> <br />
            </div>

            {/*  uPPERCASE*/}
            <div className='input-p'>
              <span>Add Uppercase Letter</span>
              <input type="checkbox" className='content-i' value='uppercase' onChange={(e) => handlechange(e)} /><br />
            </div>

            <div className='input-p'>
              <span>Add Lowercase Letter</span>
              <input type="checkbox" className='content-i' value='lowercase' onChange={(e) => handlechange(e)} /><br />
            </div>

            <div className='input-p'>
              <div>Include Numbers </div>
              <input type="checkbox" className='content-i' value='number' onChange={(e) => handlechange(e)} /><br />
            </div>

            <div className='input-p'>
              <span>Include Symbols </span>
              <input type="checkbox" className='content-i' value='symbol' onChange={(e) => handlechange(e)} /><br />
            </div>
